...
namespace EmployeeManagement.Infrastructure.Services
{
    public class BackgroundJobService : IBackgroundJobService
    {
        ...
        public string Schedule(Expression<Action> method, DateTimeOffset enqueueAt) => _backgroundJob.Schedule(method, enqueueAt);

        public string Schedule(Expression<Func<Task>> method, DateTimeOffset enqueueAt) => _backgroundJob.Schedule(method, enqueueAt);
