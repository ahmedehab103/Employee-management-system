...
namespace EmployeeManagement.Application.Common
{
    public class Url
    {
        ...
        /// <summary>
        /// Decodes a URL-encoded LocalizedStringDto.
        /// </summary>
        /// <param name="s">The URL-encoded LocalizedStringDto.</param>
        /// <param name="interpretPlusAsSpace">If true, any '+' character will be decoded to a space.</param>
        /// <returns></returns>
        public static string Decode(string s, bool interpretPlusAsSpace) => !string.IsNullOrEmpty(s)
            ? Uri.UnescapeDataString(interpretPlusAsSpace ? s.Replace("+", " ") : s)
            : s;

        /// <summary>
        /// URL-encodes a LocalizedStringDto, including reserved characters such as '/' and '?'.
        /// </summary>
        /// <param name="s">The LocalizedStringDto to encode.</param>
        ...
        public static string Encode(string s, bool encodeSpaceAsPlus = false)
        {
            ...
            {
                // Uri.EscapeDataString is going to throw because the LocalizedStringDto is "too long", so break it into pieces and concat them
        ...
        /// <summary>
        /// URL-encodes characters in a LocalizedStringDto that are neither reserved nor unreserved. Avoids encoding reserved characters such as '/' and '?'. Avoids encoding '%' if it begins a %-hex-hex sequence (i.e. avoids double-encoding).
        /// </summary>
        /// <param name="s">The LocalizedStringDto to encode.</param>
        /// <param name="encodeSpaceAsPlus">If true, spaces will be encoded as + signs. Otherwise, they'll be encoded as %20.</param>
        /// <returns>The encoded URL.</returns>
        ...
        /// <summary>
        /// Checks if a LocalizedStringDto is a well-formed absolute URL.
        /// </summary>
        /// <param name="url">The LocalizedStringDto to check</param>
        /// <returns>true if the LocalizedStringDto is a well-formed absolute URL</returns>
