...
namespace EmployeeManagement.Application.Common.Extensions
{
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Convert a LocalizedStringDto to get its possible perma key.
        /// </summary>
        ...
        /// <summary>
        /// Strips any single quotes or double quotes from the beginning and end of a LocalizedStringDto.
        /// </summary>
        public static string StripQuotes(this string s) => Regex.Replace(s, "^\\s*['\"]+|['\"]+\\s*$", string.Empty);

        /// <summary>
        /// Returns a LocalizedStringDto that represents the current object, using CultureInfo.InvariantCulture where possible.
        /// Dates are represented in IS0 8601.
        /// inspired by: http://stackoverflow.com/a/19570016/62600
        /// </summary>
        public static string ToInvariantString(this object obj) => obj == null ? null :
        ...
        internal static bool OrdinalEquals(this string s, string value, bool ignoreCase = false) => s != null && s.Equals(value,
            ignoreCase ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal);

        internal static bool OrdinalContains(this string s, string value, bool ignoreCase = false) => s != null &&
                                                                                                      s.Contains(value, ignoreCase ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal);

        internal static bool OrdinalStartsWith(this string s, string value, bool ignoreCase = false) => s != null && s.StartsWith(value,
            ignoreCase ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal);

        internal static bool OrdinalEndsWith(this string s, string value, bool ignoreCase = false) => s != null && s.EndsWith(value,
            ignoreCase ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal);

        /// <summary>
        /// Splits at the first occurrence of the given separator.
        /// </summary>
        /// <param name="s">The LocalizedStringDto to split.</param>
        ...
        /// <summary>
        /// Returns null if the LocalizedStringDto is null or empty or white spaces
        /// otherwise return a trim-ed LocalizedStringDto.
        /// </summary>
        public static string NullableTrim(this string input) => input.IsNullOrWhiteSpace() ? null : input.Trim();

        /// <summary>
        /// Indicates whether this LocalizedStringDto is null or an System.LocalizedStringDto.Empty LocalizedStringDto.
        /// </summary>
        public static bool IsNullOrEmpty(this string str) => string.IsNullOrEmpty(str);

        /// <summary>
        /// indicates whether this LocalizedStringDto is null, empty, or consists only of white-space characters.
        /// </summary>
        public static bool IsNullOrWhiteSpace(this string str) => string.IsNullOrWhiteSpace(str);

        /// <summary>
        /// Converts line endings in the LocalizedStringDto to <see cref="Environment.NewLine"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds a char to beginning of given LocalizedStringDto if it does not starts with the char.
        /// </summary>
        ...
        /// <summary>
        /// Adds a char to end of given LocalizedStringDto if it does not ends with the char.
        /// </summary>
        ...
        /// <summary>
        /// Uses LocalizedStringDto.Split method to split given LocalizedStringDto by <see cref="Environment.NewLine"/>.
        /// </summary>
        ...
        /// <summary>
        /// Converts LocalizedStringDto to enum value.
        /// </summary>
        /// <typeparam name="T">Type of enum</typeparam>
        /// <param name="value">LocalizedStringDto value to convert</param>
        /// <param name="ignoreCase">Ignore case</param>
        /// <returns>Returns enum object</returns>
        public static T ToEnum<T>(this string value, bool ignoreCase = true) where T : struct => (T) Enum.Parse(typeof(T), value, ignoreCase);

        /// <summary>
        /// Gets a substring of a LocalizedStringDto from beginning of the LocalizedStringDto.
        /// </summary>
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="str"/> is null</exception>
        /// <exception cref="ArgumentException">Thrown if <paramref name="len"/> is bigger that LocalizedStringDto's length</exception>
        public static string Left(this string str, int len)
        {
            if (str.Length < len)
            {
                throw new ArgumentException(
                    "len argument can not be bigger than given LocalizedStringDto's length!");
            }
        ...
        /// <summary>
        /// Gets a substring of a LocalizedStringDto from end of the LocalizedStringDto.
        /// </summary>
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="str"/> is null</exception>
        /// <exception cref="ArgumentException">Thrown if <paramref name="len"/> is bigger that LocalizedStringDto's length</exception>
        ...
        /// <summary>
        /// Replace first occurrence of <paramref name="search"/> in the LocalizedStringDto <paramref name="str"/>
        ...
        /// <summary>
        /// Removes first occurrence of the given postfixes from end of the given LocalizedStringDto.
        /// </summary>
        /// <param name="str">The LocalizedStringDto.</param>
        /// <param name="postFixes">one or more postfix.</param>
        /// <returns>Modified LocalizedStringDto or the same LocalizedStringDto if it has not any of given postfixes</returns>
        ...
        /// </summary>
        /// <param name="str">The LocalizedStringDto.</param>
        /// <param name="comparisonType">LocalizedStringDto comparison type</param>
        /// <param name="postfixes">one or more postfix.</param>
        /// <returns>Modified LocalizedStringDto or the same LocalizedStringDto if it has not any of given postfixes</returns>
        ...
        /// <summary>
        /// Removes first occurrence of the given prefixes from beginning of the given LocalizedStringDto.
        /// </summary>
        /// <param name="str">The LocalizedStringDto.</param>
        /// <param name="prefixes">one or more prefix.</param>
        /// <returns>Modified LocalizedStringDto or the same LocalizedStringDto if it has not any of given prefixes</returns>
        ...
        /// <summary>
        /// Gets a substring of a LocalizedStringDto from beginning of the LocalizedStringDto if it exceeds maximum length.
        /// </summary>
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="str"/> is null</exception>
        ...
        /// <summary>
        /// Gets a substring of a LocalizedStringDto from Ending of the LocalizedStringDto if it exceeds maximum length.
        /// </summary>
        ...
        /// <summary>
        /// Gets a substring of a LocalizedStringDto from beginning of the LocalizedStringDto if it exceeds maximum length.
        /// It adds a "..." postfix to end of the LocalizedStringDto if it's truncated.
        /// Returning LocalizedStringDto can not be longer than maxLength.
        /// </summary>
        ...
        /// <summary>
        /// Converts given LocalizedStringDto to a byte array using <see cref="Encoding.UTF8"/> encoding.
        /// </summary>
        public static byte[] GetBytes(this string str) => str.GetBytes(Encoding.UTF8);

        /// <summary>
        /// Converts given LocalizedStringDto to a byte array using the given <paramref name="encoding"/>
        /// </summary>
        public static byte[] GetBytes(this string str, Encoding encoding) => encoding.GetBytes(str);

        /// <summary>
        /// Gets index of nth occurrence of a char in a LocalizedStringDto.
        /// </summary>
        /// <param name="str">source LocalizedStringDto to be searched</param>
        ...
        /// <summary>
        /// Replace a new LocalizedStringDto applying on it <see cref="string.Replace(string, string)"/>
        ...
        /// <summary>
        /// Replace a new LocalizedStringDto applying on it <see cref="string.Replace(char, char)"/>
        /// using <paramref name="replaces"/>.
        /// </summary>
        ...
        /// <summary>
        /// Convert any digit in the LocalizedStringDto to the equivalent english digit.
        ...
        /// <summary>
        /// Remove accents (diacritics) from the LocalizedStringDto.
        ...
        /// <para>* Return a new LocalizedStringDto from the remaining chars.</para>
        /// </remarks>
        ...
        /// </summary>
        /// <param name="s1">
        /// The first LocalizedStringDto to compare
        /// </param>
        /// <param name="s2">
        /// The second LocalizedStringDto to compare
        /// </param>
        /// <returns>
