...
namespace EmployeeManagement.Application.Common.Extensions
{
    public static class EnumerableExtensions
    {
        ...
        /// </summary>
        public static IEnumerable<T> DistinctBy<T, TKey>(this IEnumerable<T> enumerable, Func<T, TKey> projection) => enumerable.Distinct(new ProjectionEqualityComparer<T, TKey>(projection));
        ...
        /// This is a shortcut for LocalizedStringDto.Join(...)
        /// </summary>
        /// <param name="source">A collection that contains the objects to concatenate.</param>
        /// <param name="separator">
        /// The LocalizedStringDto to use as a separator. separator is included in the returned LocalizedStringDto only if values
        /// has more than one element.
        /// </param>
        /// <typeparam name="T">The type of the members of values.</typeparam>
        /// <returns>
        /// A LocalizedStringDto that consists of the members of values delimited by the separator LocalizedStringDto. If values has no
        /// members,
        /// the method returns System.LocalizedStringDto.Empty.
        /// </returns>
        ...
        /// </summary>
        public static IEnumerable<T> Duplicates<T>(this IEnumerable<T> enumerable) => enumerable
            .GroupBy(c => c)
            .Where(g => g.Count() > 1)
            .Select(y => y.Key);
    }
