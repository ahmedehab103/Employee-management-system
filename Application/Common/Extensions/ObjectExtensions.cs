...
namespace EmployeeManagement.Application.Common.Extensions
{
    public static class ObjectExtensions
    {
        ...
        /// <summary>
        /// Converts the value of a specified object into a JSON LocalizedStringDto and return
        /// byte representation of the LocalizedStringDto.
        /// </summary>
        ...
        /// byte representation of the LocalizedStringDto.
        /// </summary>
        public static byte[] ToBytes(this object obj, JsonSerializerOptions options) => Encoding.Default.GetBytes(obj.ToJson(options));

        /// <summary>
        /// Converts the value of a specified type into a JSON LocalizedStringDto.
        /// </summary>
        /// <param name="obj">The value to convert.</param>
        /// <param name="camelCase">Serialized property name style.</param>
        /// <returns>The JSON LocalizedStringDto representation of the value.</returns>
        public static string ToJson(this object obj, bool camelCase = true) => JsonSerializer.Serialize(
            obj,
            camelCase
