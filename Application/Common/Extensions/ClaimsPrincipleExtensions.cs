...
namespace EmployeeManagement.Application.Common.Extensions
{
    public static class ClaimsPrincipleExtensions
    {
        ...
        /// </summary>
        public static IList<Claim> Claims(this ClaimsPrincipal claimsPrincipal, string claimType) => claimsPrincipal?.FindAll(claimType).ToList();

        /// <summary>
        /// Get user roles collection.
        /// </summary>
        public static IList<string> Roles(this ClaimsPrincipal principal, string claimType = ClaimTypes.Role) => principal?.Claims.Where(c => c.Type == claimType).Select(c => c.Value).ToList();
        ...
        public static List<Guid> CompaniesIds(this ClaimsPrincipal principal, string claimType) => principal?.Claims.Where(c => c.Type == claimType)
