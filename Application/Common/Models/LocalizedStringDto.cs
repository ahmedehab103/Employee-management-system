...
using LocalizedString = EmployeeManagement.Domain.ValueObjects.LocalizedString;
...
namespace EmployeeManagement.Application.Common.Models
{
    public class LocalizedStringDto
    {
        ...
        public static LocalizedStringDto Create(LocalizedString source) => new()
        {
            Ar = source.Ar,
            En = source.En
        };

        public static bool operator ==(LocalizedString str, LocalizedStringDto dto) => str?.Ar == dto?.Ar || str?.En == dto?.En;

        public static bool operator !=(LocalizedString str, LocalizedStringDto dto) => str?.Ar != dto?.Ar || str?.En != dto?.En;

        public static LocalizedStringDto Create(WeakLocalizedString source) => new()
        {
            Ar = source.Ar,
            En = source.En
        };
