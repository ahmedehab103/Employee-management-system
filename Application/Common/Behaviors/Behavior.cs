...
namespace EmployeeManagement.Application.Common.Behaviors
{
    ...
    public class Behavior<TRequest>
    {
        ...
        public void LogInformation(string key, TRequest request, Dictionary<string, object> extra = null) => Log(key, request, _logger.LogInformation, extra);

        public void LogWarning(string key, TRequest request, Dictionary<string, object> extra = null) => Log(key, request, _logger.LogWarning, extra);

        public void LogCritical(string key, TRequest request, Dictionary<string, object> extra = null) => Log(key, request, _logger.LogCritical, extra);

        public void LogError(string key, TRequest request, Dictionary<string, object> extra = null) => Log(key, request, _logger.LogError, extra);
