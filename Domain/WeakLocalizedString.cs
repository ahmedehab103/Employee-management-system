...
using AmbiguousMatchException = EmployeeManagement.Domain.Exceptions.AmbiguousMatchException;
...
namespace EmployeeManagement.Domain.ValueObjects
{
    public class WeakLocalizedString : ValueObject
    {
        ...
        public static explicit operator WeakLocalizedString((string ar, string en) values) => new()
        {
            Ar = values.ar,
            En = values.en
        };
